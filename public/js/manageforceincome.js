$(document).ready(function() {
    ...
    $('#btn_income').on('click', function() {
        ...
        $.ajax({
            type: "POST",
            url: "http://124.248.202.226:8888/manage/income/update",
            dataType: "json",
    ...
    $('#save_income_list').on('click', function() {
        ...
        $.ajax({
            type: "POST",
            url: "http://124.248.202.226:8888/manage/incomelist/add",
            dataType: "json",
    ...
    $('#group_type').on('change', function() {
        ...
        location.replace("http://124.248.202.226:8888/manage/income/" + this.value);
    });
    ...
    $("#dataTable").on("click", '#income_status', function(event) {
        ...
        $.ajax({
            type: "POST",
            url: "http://124.248.202.226:8888/manage/income/status",
            dataType: "json",
    ...
    $("#dataTable").on("click", '#delete_income', function(event) {
        ...
        $.ajax({
            type: "POST",
            url: "http://124.248.202.226:8888/manage/income/delete",
            dataType: "json",
